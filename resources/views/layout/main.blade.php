...
<head>
    ...
    <title>Noise Reactor</title>
    <link rel="stylesheet" href="{{ asset('css/app.css') }}">
</head>

<body class="bg-gray-100 text-gray-700">
    <header class="sticky top-0 z-40 mx-auto max-w-7xl p-5 md:flex md:justify-between h-auto items-center" x-data="{ isOpen: false }">
        ...
        <nav class="md:inline" :class="isOpen ? 'show' : 'hidden'" @click.away="isOpen = false">
            <ul class="menu">
                ...
                <li class="md:ml-1 mt-10 md:mt-0 md:w-auto"><a class="login" href="#">Log in</a></li>
            </ul>
        </nav>
    </header>
